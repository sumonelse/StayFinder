    ...
    return (
        <div className="animate-pulse">
            ...
            <div className="mb-6">
                ...
                <div className="h-5 bg-secondary-200 rounded w-1/2 mb-4"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                <div className="h-72 bg-secondary-200 rounded"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                ...
                <div className="col-span-2">
                    <div className="h-7 bg-secondary-200 rounded w-1/3 mb-4"></div>
                    <div className="h-4 bg-secondary-200 rounded w-full mb-2"></div>
                    <div className="h-4 bg-secondary-200 rounded w-full mb-2"></div>
                    <div className="h-4 bg-secondary-200 rounded w-3/4 mb-6"></div>
                ...
                <div className="col-span-1">
                    <div className="bg-secondary-100 rounded-lg p-6">
                        <div className="h-7 bg-secondary-200 rounded w-1/2 mb-4"></div>
                        <div className="h-5 bg-secondary-200 rounded w-full mb-4"></div>
                        <div className="h-10 bg-secondary-200 rounded w-full mb-4"></div>
                        <div className="h-10 bg-secondary-200 rounded w-full mb-4"></div>
                        <div className="h-12 bg-secondary-200 rounded w-full mb-4"></div>
                        <div className="h-4 bg-secondary-200 rounded w-full mb-2"></div>
