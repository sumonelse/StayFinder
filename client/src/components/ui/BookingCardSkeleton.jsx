        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden animate-pulse border border-secondary-100">
            <div className="p-5">
                ...
                <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="h-6 bg-secondary-200 rounded-full w-24"></div>
                </div>

                {/* Property info */}
                <div className="flex flex-col md:flex-row gap-4 mb-4">
                    {/* Image placeholder */}
                    <div className="h-32 w-full md:w-48 bg-secondary-200 rounded-lg"></div>
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex gap-2 items-center mb-2">
                            <div className="h-4 w-4 bg-secondary-200 rounded-full"></div>
