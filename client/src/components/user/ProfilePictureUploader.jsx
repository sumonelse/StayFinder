...
const ProfilePictureUploader = ({
    ...
    return (
        <div className={`flex flex-col items-center ${className}`}>
            ...
            <label className="cursor-pointer px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50">
                <input
                    type="file"
                    accept="image/*"
                    className="hidden"
